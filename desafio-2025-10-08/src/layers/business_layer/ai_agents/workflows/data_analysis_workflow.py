...
class DataAnalysisWorkflow(BaseWorkflow):
    def __init__(
        ...
        self.eda_tools = [GenerateDistributionTool]
    ...
    def _add_nodes(self, builder: StateGraph) -> None:
        ...
        builder.add_node(
            node="data_analysis_agent_tools_node",
            action=self.data_analysis_agent_tools_node,
        )
        builder.add_node(
        ...
        builder.add_node("cleanup_node", self.cleanup_node)
    ...
    def _add_edges(self, builder: StateGraph) -> None:
        ...
        builder.add_edge(
            start_key="data_analysis_agent_tools_node",
        ...
        builder.add_conditional_edges(
            ...
            path=functools.partial(
                ...
                routes_to_by_tool_name={
                    "python_repl_ast": "data_analysis_agent_tools_node",
                    "get_data_types_tool": "data_analysis_agent_tools_node",
                    "generate_distribution_tool": "data_analysis_agent_tools_node",
                },
            ),
            path_map={
                "data_analysis_agent_tools_node": "data_analysis_agent_tools_node",
                self.supervisor_agent.name: self.supervisor_agent.name,
            },
        )
        builder.add_conditional_edges(
    ...
    #     is_final_plot_value = state.get("is_final_plot")

    #     if is_final_plot_value:
    #         state["is_final_plot"] = None
    #         routes_to = END
    ...
    def data_analysis_agent_tools_node(
