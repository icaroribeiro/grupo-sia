...
#         ..., description="A dictionary of lists of SQLAlchemy database models."
#     )
...
#     description: str = """
#     Insert SQLALchemy database models into Postgres database using SQLALchemy ORM.
#     Returns:
...
#     async def _arun(
#         self,
#         models_dict: dict[int, list[InvoiceModel | InvoiceItemModel]],
#     ) -> ToolOutput:
