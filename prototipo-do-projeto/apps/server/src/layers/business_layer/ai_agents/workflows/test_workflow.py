            ...
            [
                (
                    ...
                    **Routing Logic:**
                    ...
                    - If assistant_1 has provided a number, you should route to assistant_2 to check if it's prime.
                    - If assistant_2 has provided a result (true/false), you should route to FINISH.
